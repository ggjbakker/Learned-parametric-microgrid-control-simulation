classdef microgridParametricControllerLearned < MLDController
    properties
    ...
    methods
        ...
        %
        function obj = microgridParametricControllerLearned(MLD,N,predictor)
...
%             obj.prob.ConsDiff = 6;
        ...
        function [u,result] = control(obj,z,zm1,u0,theta0) 
            ...
            obj.prob.user.csale0 = zm1(2);
            obj.prob.user.cbuy0 = zm1(1);
            ...
            V = conPar_V_gen5(result.x_k,obj.prob);
            result.V = V;
        ...
        function createProb(obj)
            obj.prob = conAssign('conPar_f_gen5','conPar_g_gen5',[],[],[],[],'parMPC',zeros(9,1),[],'-1E10',[],[],[],'conPar_c_gen5',[],[],[],-10^10*ones(obj.MLD.nx*obj.N*2+obj.MLD.nconstraints*obj.N+obj.N+obj.N*(obj.MLD.nu+obj.MLD.nz),1),10^10*ones(obj.MLD.nx*obj.N*2+obj.MLD.nconstraints*obj.N+obj.N+obj.N*(obj.MLD.nu+obj.MLD.nz),1));
            ...
            obj.prob.user.uub = obj.MLD.uub;
            obj.prob.user.ulb = obj.MLD.ulb;
